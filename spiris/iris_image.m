function [I_ref, I_tot, I_scat] = iris_image(scattered, reflected, micr, mediumIndex)
% I = iris_image(scattered, reflected, micr)
% 
% Calculate the resulting IRIS image from the scattered and reflected fields
...
% Novotny Eq. 3.33
sca_prefactor = 1i/(2*pi); %r*exp(-i*k*r) is already included in the far field solution
